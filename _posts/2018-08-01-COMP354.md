...
* An effective design pattern in the following way:
    ...
    * The pattern has a signifi cant human component (minimize human intervention)
...
![Pattern-based design in context]({{ site.url }}/assets/Pattern_in_context.png "Pattern-based design in context 2")

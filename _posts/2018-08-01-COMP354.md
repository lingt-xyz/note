...
* **Solution**: When related behaviour varies by type, assign responsibility for the behaviour to the types for which
the behaviour varies, generally by using polymorphic operations.

...
* I differ with Larman’s approach to a diagram focus for this. It may be doable some places, but text describing its application, supported by class/sequence (or any interaction diagrams) are best to describe this.

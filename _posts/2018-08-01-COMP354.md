...
<object data="designpatternscard.pdf" type="application/pdf" width="750px" height="750px">
    <embed src="designpatternscard.pdf" type="application/pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="designpatternscard.pdf">Download PDF</a>.</p>
    </embed>
</object>

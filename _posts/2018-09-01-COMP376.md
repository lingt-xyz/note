...
1. Representation
    ...
    A game is a closed formal system that represents a subset of reality + some fantasy.
...
3. Conflict: 
    ...
    The player actively pursues some goal while obstacles prevent goals from
being easily achieved. Sources of conflict include:

...
\begin{align}
\overline {N} = N - \sum_{1\leqslant i \leqslant t} N(c_i) + \sum_{1\leqslant i \leqslant j \leqslant t} N(c_i c_j) - \sum_{1\leqslant i \leqslant j \leqslant k \leqslant t} N(c_i c_j c_k) +  \dots + (-1)^t N(c_1 c_2 c_3 \dots c_t)
\end{align}

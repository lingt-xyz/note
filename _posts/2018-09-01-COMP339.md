...
* Corollary 1.1 For each integer {% raw %}$$n\gt0$${% endraw %}.
    *  {% raw %}$$ \binom{n}{0}+\binom{n}{1}+\binom{n}{2}+\dots+\binom{n}{n}=2^n$${% endraw %}
    *  {% raw %}$$ \binom{n}{0}-\binom{n}{1}+\binom{n}{2}-\dots+(-1)^n\binom{n}{n}=0$${% endraw %}
...
## Chapter 11 Anintroduction to Graph Theory

...
5. 3 Objects into 10 numbered boxe, at most one per box:
    ...
    2. Otherwise: {% raw %}$$C(10, 3)={10!\over7!3!}=\binom{10}{3}$${% endraw %}
...
8. Choose a committe of 3 from 80 students:
    1. (It's a committe, so order does not matter): {% raw %}$$\binom{80}{3}=C(80, 3)={80!\over77!3!}$${% endraw %}
    2. If choose 77, should be the same: {% raw %}$$\binom{80}{77}=C(80, 77)={80!\over3!77!}$${% endraw %}
